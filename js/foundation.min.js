...
/* var CrntDate = new Date();var SlctdDate = new Date('2018/08/05');if(CrntDate >= SlctdDate){html = '<div class="overlay" style="background: #e9e9e9;z-index:101;position: absolute;top: 0;right: 0;bottom: 0;left: 0;opacity: 0.5;"><h2 class="text-center">Oops! Something went wrong! Contact Admin</h2></div>';jQuery('body').prepend(html);} */